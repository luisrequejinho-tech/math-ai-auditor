...
- **Notebook** (renders natively on GitHub): [math_auditor_4.ipynb](math_auditor_4.ipynb)
- **Standalone HTML version** (no Jupyter required): [view rendered HTML](math_ai_auditor.html)
...
| `math_auditor_4.ipynb` | Original Jupyter notebook |
| `math_ai_auditor.html` | Standalone HTML export of the notebook |
